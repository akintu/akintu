...
#HOUSES AND DUNGEONS
SHOP = (ITEMS_IMAGES_PATH, "shop.png", TILE_SIZE, None, None)
...
WALL_SHEET = (BACKGROUND_IMAGES_PATH, "walls.png", TILE_SIZE, None, None)
DOOR_SHEET = (BACKGROUND_IMAGES_PATH, "doors.png", TILE_SIZE, None, None)
...
SHEETS = {CHEST_KEY: CHEST, SHOP_KEY: SHOP, PATH_KEY: PATH_SHEET, WALL_KEY: WALL_SHEET, DOOR_KEY: DOOR_SHEET}
