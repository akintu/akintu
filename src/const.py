...
TILE_TOP_LEFT = tuple((0, 0))
TILE_TOP_RIGHT = tuple((PANE_X-1, 0))
TILE_BOTTOM_LEFT = tuple((0, PANE_Y-1))
TILE_BOTTOM_RIGHT = tuple((PANE_X-1, PANE_Y-1))

TILES_LEFT = tuple((TILE_TOP_LEFT, TILE_BOTTOM_LEFT))
TILES_TOP = tuple((TILE_TOP_LEFT, TILE_TOP_RIGHT))
TILES_RIGHT = tuple((TILE_TOP_RIGHT, TILE_BOTTOM_RIGHT))
TILES_BOTTOM = tuple((TILE_BOTTOM_LEFT, TILE_BOTTOM_RIGHT))
